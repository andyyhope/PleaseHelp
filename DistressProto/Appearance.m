...
+ (void)addBackButtonToViewController:(UIViewController *)viewController
{
    ...
    UIBarButtonItem *barButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:kBACK_BUTTON] style:UIBarButtonItemStyleBordered target:viewController action:@selector(dismissView)];
...
+ (void)addCancelButtonToViewController:(UIViewController *)viewController
{
    ...
    UIBarButtonItem *barButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:kCANCEL_BUTTON] style:UIBarButtonItemStyleBordered target:viewController action:@selector(dismissView)];
    barButtonItem.tintColor = [UIColor whiteColor];
...
+ (void)addSaveButtonToViewController:(UIViewController *)viewController
{
    ...
    UIBarButtonItem *barButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:kSAVE_BUTTON] style:UIBarButtonItemStyleBordered target:viewController action:@selector(save)];
    barButtonItem.tintColor = [UIColor whiteColor];
...
+ (void)addSaveButtonToEditViewController:(UIViewController *)viewController
{
    ...
    UIBarButtonItem *barButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:kSAVE_BUTTON] style:UIBarButtonItemStyleBordered target:viewController action:@selector(saveEdit:)];
    barButtonItem.tintColor = [UIColor whiteColor];
